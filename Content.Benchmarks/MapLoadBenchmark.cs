...
public class MapLoadBenchmark
{
    ...
    public static readonly string[] MapsSource = { "Empty", "Bagel", "Dev", "CentComm", "Atlas", "Core", "TestTeg", "Packed", "Omega", "Cluster", "Reach", "MeteorArena", "Oasis", "Barratry", "Amber"}; //Ratbite, trim test to maps under Ratbite_Supported
